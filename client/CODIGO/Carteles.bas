...
GUI_Grh_Render textura, XPosCartel, YPosCartel, , , RGB(255, 255, 255)

Dim j As Integer, desp As Integer

For j = 0 To UBound(LeyendaFormateada)
    dxTextRender 1, LeyendaFormateada(j), x, y + desp, D3DColorXRGB(255, 255, 255) 'Len(LeyendaFormateada(j)) * 10, 20, vbWhite
