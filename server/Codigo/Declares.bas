...
Public Const MAXSPAWNATTEMPS As Byte = 60
Public Const LoopAdEternum As Integer = -1
Public Const FXSANGRE As Byte = 14
...
Public Const VaraMataDragonesIndex As Integer = 1020
...
Public Enum FXIDs
    ...
    FXMEDITARCHICO = 4
    FXMEDITARMEDIANO = 5
    FXMEDITARMEDIANOB = 39
    FXMEDITARGRANDECIUDA = 43
    FXMEDITARGRANDECRIMI = 41
    FXMEDITARXGRANDECRIMI = 40
    FXMEDITARXGRANDECIUDA = 42
End Enum
...
Public Const MAPATORNEO As Integer = 91
Public Const MAPAESPERA As Integer = 90
Public Const REYCAOS As Integer = 941
Public Const REYREAL As Integer = 942

Public PosDelRey As WorldPos
...
'Sistems Vars
Public NumQuest As Byte 'no creo que haya mas de 255...
Public NumInvocaciones As Byte
Public NumTronos As Byte

Public Type QuestNpcInfo
    NpcIndex As Integer
    amount As Integer
End Type

'Esta es la informacion que tiene el usuario de la quest que esta realizando.
Public Type tQuest
    estado As Byte
    NpcInfo As QuestNpcInfo
End Type
'Estructura que contiene la informacion de todas las quest del usuario
Public Type QuestInfo
    Completadas As Integer
    UserQuest() As tQuest
End Type

'En esta estructura cargamos la informacion de la quest en si.
Public Type Quest
    Pedido As Obj
    Recompensa As Obj
    ObjInicial As Obj
    ...
    Desc As String
    Desc2 As String 'Esta descripcion es cuando terminaste la quest cosa de que no quede discordante.
...
'Para zonas de invocacion
Public Type tInvocationZone
    NpcInvocado As Integer
    CantidadNpc As Integer
    CantidadUsers As Integer
    UserPos() As WorldPos
    NpcPos As WorldPos
    TiempoInvocacion As Integer
    Counter As Integer
    EnabledCounter As Integer
End Type

Public Type tTrono
    Pos As WorldPos
    Counter As Integer
    TiempoTrono As Integer
End Type

Public Type tCastillo
    Map As Integer
    LeaderFaccion As e_Alineacion
    name As String
    UnderAttack As Byte
End Type
...
Public Type tFacciones
    Alineacion As e_Alineacion
    CriminalesMatados As Long
    CiudadanosMatados As Long
    NeutralesMatados As Long
    RangoFaccionario As Byte
    SalioFaccion As Byte
    SalioFaccionCounter As Byte
End Type

Public Type tAccount
    name As String
    CharCount As Byte
    Chars(1 To MAX_ACCOUNT_CHARS) As String
    Boveda As BancoInventory
    Logged As Boolean
End Type

'Tipo de los Usuarios
Public Type User
    UserAccount As tAccount
    name As String
    ID As Long
...
Type MapInfo
    ...
    PoseidoPor As Integer 'Clan que posee el mapa.
...
'Codigo de torneos by blizzard
Public Torneo As Boolean
Public Inscripciones As Byte
Public Inscriptos As Byte
Public InscripcionesAbiertas As Boolean
'Variables publicas de subastas by blizzard
Public SubastaEnCurso As Byte
Public MaxMinutosSubasta As Byte
Public MinutosSubasta As Byte
Public SubastaObjIndex As Integer
Public SubastaUserIndex As Integer
Public MayorOferta As Long
Public SubastaMinimo As Long
Public MayorOfertaUserIndex As Integer
''
...
Public Quest() As Quest
Public Invocacion() As tInvocationZone
Public Trono() As tTrono
Public PremiosInfo() As tPremios 'Contiene los indices de los premios
Public Castillo(1 To 2) As tCastillo
'*********************************************************
...
Public DungeonNewbie As WorldPos
