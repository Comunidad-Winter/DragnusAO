...
'        azar = 1
    ...
    Case 3
        ...
        Call SendData(SendTarget.ToNPCArea, npcind, PrepareMessageCreateFX(Npclist(npcind).Char.CharIndex, FXIDs.FXMEDITARGRANDECRIMI, LoopAdEternum))
        ...
        If BestTarget > 0 Then
            ...
            For Headingloop = eHeading.NORTH To eHeading.WEST
                ...
                If InMapBounds(nPos.Map, nPos.X, nPos.Y) Then
                    ...
                    If UI > 0 Then
                        If npcAttackUser(npcind, UI) Then
