...
Public Sub StoreFrag(ByVal killer As Integer, ByVal victim As Integer)
    ...
    If UserList(killer).Faccion.Alineacion = e_Alineacion.Real Then
        alignment = 1
    ElseIf UserList(killer).Faccion.Alineacion = e_Alineacion.Caos Then
        alignment = 2
    ElseIf UserList(killer).Faccion.Alineacion = e_Alineacion.Neutro Then
        alignment = 3
    End If
