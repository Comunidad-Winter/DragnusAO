...
'2) Acabo de resetear la funcion closeConnection a como esta
...
'restauracion de closeConnection [olvide NumUsers = NumUsers -1]
...
'func closeConnection (bueh..un poko modifikada ta)
...
'que al desconectarse el cliente se llame de nuevo a closeConnection
