...
'---SOCKET FUNCTIONS
    ...
    Public Declare Function apicloseConnection Lib "ws2_32.DLL" Alias "closeConnection" (ByVal S As Integer) As Integer
...
'---SOCKET FUNCTIONS
    ...
    Public Declare Function apicloseConnection Lib "wsock32.dll" Alias "closeConnection" (ByVal S As Long) As Long
